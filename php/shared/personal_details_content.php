<section class="personal-details" id="personalDetails">
  <div class="pd-heading">
    ...
    <span class="pd-lock"><i class="fa-solid fa-lock"></i> Password protected</span>
  </div>
  <form id="personalDetailsForm" novalidate>
    ...
    <fieldset><legend>Personal Information</legend><div class="pd-grid">
      ...
      <label>Name Extension<input name="extension" placeholder="Jr., Sr., III" /></label>
      <label>Birthdate<input type="date" name="birthdate" required /></label>
      <label>Age<input name="age" readonly /></label>
      <label>Gender<select name="gender" required><option value="">Select</option><option value="male">Male</option><option value="female">Female</option></select></label>
    </div></fieldset>
    <fieldset><legend>Address Information</legend><div class="pd-grid">
      <label>Purok / Street<input name="street" required /></label><label>Barangay<input name="barangay" required /></label>
      <label>Municipal / City<input name="city" required /></label><label>Province<input name="province" required /></label>
      <label>Country<input name="country" required /></label><label>Zip Code<input name="zip" required /></label>
    </div></fieldset>
    <fieldset><legend>Security Questions</legend>
      ...
      <div class="pd-security-grid">
        ...
        foreach ($questionGroups as $number => $questions): ?>
          ...
          <label>New Answer <?= $number ?><input type="password" name="security_answer_<?= $number ?>" autocomplete="off" placeholder="Leave blank to keep saved answer" /></label>
        <?php endforeach; ?>
      </div>
    </fieldset>
    <div class="pd-verify">
      <label>Current Password<input type="password" name="operator_password" autocomplete="current-password" required /></label>
      <p>Your current password is required before any changes are saved.</p>
    </div>
