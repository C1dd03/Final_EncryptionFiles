                        ...
                        <div class="form-grid modal-two-col-grid" id="securitySectionGrid">
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <select id="formSecQ1" name="security_question_1" class="form-control" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="formSecQ2" name="security_question_2" class="form-control" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="formSecQ3" name="security_question_3" class="form-control" required>
                            ...
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <input type="password" id="formSecA1" name="security_q1" class="form-control" placeholder="Answer 1" required />
                                    <div class="input-error-container" aria-live="polite"></div>
                                </div>

                                <div class="form-group">
                                    <label for="formSecA2">Answer 2 *</label>
                                    <input type="password" id="formSecA2" name="security_q2" class="form-control" placeholder="Answer 2" required />
                                    <div class="input-error-container" aria-live="polite"></div>
                                </div>

                                <div class="form-group">
                                    <label for="formSecA3">Answer 3 *</label>
                                    <input type="password" id="formSecA3" name="security_q3" class="form-control" placeholder="Answer 3" required />
                                    <div class="input-error-container" aria-live="polite"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-grid modal-two-col-grid">
                            <div class="form-col">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="formUsername" name="username" class="form-control" placeholder="user.username" required />
                                    <div class="input-error-container" aria-live="polite"></div>
                                </div>

                                <div class="form-group">
                                    <label for="formEmail">Email Address *</label>
                                    <input type="email" id="formEmail" name="email" class="form-control" placeholder="user@example.com" required />
                                    <div class="input-error-container" aria-live="polite"></div>
                                </div>
